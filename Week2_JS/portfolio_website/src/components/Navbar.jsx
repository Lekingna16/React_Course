...
const Navbar = ({ darkMode, toggleDarkMode }) => {
    ...
    const colors = darkMode ? darkColors : lighhtColors;
                ...
                w-full space-x-6 lg:space-x-8 ">
                            ...
                            <a
                                ...
                                <motion.span
                                    ...
                                    ${activeSection == item.name.toLowerCase()
                                            ? colors.textActive
                                            : `${colors.texttSecondary} hover:text-orange-500`
                                        }`}
                                    whileHover={{ scale: 1.05 }}
                                    whileTap={{ scale: 0.95 }}
                                >
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <motion.a
                            ...
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className={`hidden l:block px-6 py-2 font-semibold
                                ...
                                <a
                                    ...
                                    <motion.div
                                        ...
                                        <span className={`font-medium ${activeSection === item.name.toLowerCase()
                                            ? colors.textActive : colors.texttSecondary
                                            }`}>
                                            {item.name}
